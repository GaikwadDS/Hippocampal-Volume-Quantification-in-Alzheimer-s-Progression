...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: slice number, image predicted by slice and shape of predicted image. 
    ...
    def run_test(self):
        ...
        # TASK:        Inference Agent is not complete. Go and finish it. Feel free to test the clas   # in a module of your own by running it against one of the data samples
